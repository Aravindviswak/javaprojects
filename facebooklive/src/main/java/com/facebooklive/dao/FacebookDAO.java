...
public class FacebookDAO implements FacebookDAOInterface {
	...
	public List<FacebookUser> searchProfileDAO(FacebookUser fb) {
		...
		Session s=sf.openSession();
		Query q=s.createQuery("from com.facebooklive.entity.FacebookUser f where f.email=:e");
	...
	public int editProfileDAO(FacebookUser fb) {
		int i=0;
		Session s=sf.openSession();
		Query q=s.createQuery("from com.facebooklive.entity.FacebookUser f where f.email=:email and f.password=:password");
	...
	public int deleteProfileDAO(FacebookUser fb) {
		...
		EntityTransaction et=s.getTransaction();
		et.begin();
		Query q=s.createQuery("delete com.facebooklive.entity.FacebookUser f where f.email=:e");
		q.setParameter("e",fb.getEmail());
	...
	public FacebookUser viewProfileDAO(FacebookUser fb) {
		...
		Session s=sf.openSession();
		Query q=s.createQuery("from com.facebooklive.entity.FacebookUser f where  f.email=:email ");
		q.setParameter("email",fb.getEmail());
